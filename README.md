...
[![Docker Pulls](https://img.shields.io/docker/pulls/afreisinger/github-runner)](https://hub.docker.com/r/afreisinger/github-runner)
...
For now, there are only Debian Bookworm (tagged with `latest`) image, but I may add more variants in the future. Feel free to create an issue if you want another base image.
...
services:
    runner:
      image: afreisinger/github-runner:latest
      environment:
...
GITHUB_ACCESS_TOKEN=the_runner_token or personal_access_token
```
